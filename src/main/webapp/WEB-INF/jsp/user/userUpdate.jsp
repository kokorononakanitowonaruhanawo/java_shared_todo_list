...
<body>
	...
	<div class="container">
		<div class="row my-2">
			<div class="alert alert-info">変更してください</div>
		</div>

		<!-- 入力フォーム -->
		<div class="row my-2">
 			<form action="/shared_todo_list/UserUpdateServlet" method="post">
				<div class="mb-3">
					<div class="row">
					...
					<div class="col-sm-12">
						<input type="text" class="form-control" id="email" name="email"
							value="${sessionScope.login_user.getEmail()}">
					</div>
				</div>
				<div class="mb-3">
					<div class="row">
				...
				<div class="mb-3">
					<div class="row">
						<label for="pass2" class="col-sm-3 col-form-label">password（確認）</label>
						<div class="col-sm-9">
							<!-- エラーメッセージ -->
				...
				<div class="mb-5">
					...
					<div class="col-sm-12">
						<input type="text" id="name" name="name" class="form-control"
							value="${sessionScope.login_user.getName()}">
					</div>
				</div>
